...
|----|---|---------------------------|-----------|-------------|------------------|
| `ENC-grid` | **L4** | A Ch2 makespan-optimal tour is reachable by retiming a fixed visit order on a uniform time-grid encoding. | E-759 (idle 100% order-forced, 0.0d retime-removable); C-036 epoch-shift trap | Ch2 retiming-based "floor/walled" verdicts (medium M1 null; small retime floor) | **RE-RUN done on small (E-760) + medium (E-761):** small improved 112.996->111.96 then L4-walled; medium 0 improvement (L4 floor). ENC-grid walls BOTH at L4 for the rank-1 residual. Large RE-RUN = decompose+couple (E-762). |
