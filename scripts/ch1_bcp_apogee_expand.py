"""Expand pair pool via BCP-apogee 3-impulse on unused Earth orbits.

For each UNUSED Earth orbit (high-iE pairs that 2-impulse couldn't solve):
- Try BCP-apogee 3-impulse with sweep
- For each unused idE, pick top-K best Moon orbit candidates by Hohmann
- Solve, save to results dict for Hungarian rebank
"""
import sys
import time
import json
...
def main(K=3, n_workers=8,
          out_results="/home/julian/Projects/esa_spoc_26_3/runs/ch1/bcp_apogee_expand_results.json"):
    ...
    for idE in unused_e:
        ...
        for idL in range(400):
            ...
            # STRONG bias to unused idLs (pure addition to bank)
